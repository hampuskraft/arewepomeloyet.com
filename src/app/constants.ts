...
export const CallbackCodeToMessage: Record<CallbackCode, string> = {
  ...
  [CallbackCode.NotEligibleStaff]: "You're a staff member! We can't count your Pomelo.",
  [CallbackCode.NotEligiblePartner]: "You're a partner! We can't count your Pomelo.",
